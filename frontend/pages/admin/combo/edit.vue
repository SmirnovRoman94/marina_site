      ...
      <v-col cols="12" md="6">
        ...
        <div class="mt-5">
          <v-form  @submit.prevent="createCombo" ref="form">
            ...
            <div class="mt-5">
              <v-img class="align-end text-white" height="300" width="100%" object-cover  :src="combo.image" cover/>
            </div>
            <div class="mt-5">
...
onMounted(async() => {
  await store.GET_COMBO_ITEM(route.query.id)
      .then(res=>{
        console.log(res)
        Object.assign(combo, res.data.data)
        combo.count_level = 0;
      });
