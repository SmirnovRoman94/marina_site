  ...
  <v-container>
    <v-row>
      <v-col cols="12" md="6">
        ...
        <div class="mt-5">
          <v-form fast-fail @submit.prevent="createService" ref="form">
            <div>
            ...
            <div class="mt-5">
              <v-img class="align-end text-white" height="400" width="100%" object-cover  :src="service.image" cover/>
            </div>
            <div class="mt-5">
...
onMounted(async() => {
  await store.GET_SERVICE_ITEM(route.query.id)
      .then(res=>{
        console.log(res)
